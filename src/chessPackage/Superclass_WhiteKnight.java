...
public class Superclass_WhiteKnight extends WhitePiece {
	static ImageIcon getIcon(){
		URL White_Knight_URL = Chess.class.getResource("chess_piece_white_knight.png");
		ImageIcon White_Knight_Icon = new ImageIcon(White_Knight_URL);
	...
	static int [][] searcherOneTile( int[][]MultiArray,int CurrentX, int CurrentY){
		//this function looks for a white piece blocking knight movement
		int [] NewXY=new int[2];
		int [] NewXY2=new int[2];
		int [] NewXY3=new int[2];
		int [] NewXY4=new int[2];
	...
	static int[][] movementEngine(int[] NewXY,int[][]MultiArray, int j){
		for(int i = 0 ; i < aggregateWhites().length ; i++) {
			...
			if(Arrays.equals(Coordinate, NewXY)){
				System.out.println("We have found a white piece interrupting this knight");
				return MultiArray;
	...
	static int [][] checkPreventer( int[][]MultiArray,int CurrentX, int CurrentY){
		//this function prevents check against White King
		int [] NewXY1 = new int[2];
		int [] NewXY2 = new int[2];
		int [] NewXY3 = new int[2];
		int [] NewXY4 = new int[2];
		...
		for(int i = 0 ; i < MultiArray.length ; i++) {
			...
			if(Arrays.equals(MultiArray[i], NewXY1)){
				System.out.println("White Knight threatining check");
				MultiArray[i]=null;
