...
public class Superclass_BlackQueen extends BlackPiece {
	static ImageIcon getIcon(){
		URL Black_Queen_URL = Chess.class.getResource("chess_piece_black_queen.png");
		ImageIcon Black_Queen_Icon = new ImageIcon(Black_Queen_URL);
